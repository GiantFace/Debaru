...
export const serviceIcons = {
  ...
  // Tisztatéri kivitelezés — pajzs pipával
  'tisztateri-villamoskivitelezes': () => (
    <svg {...svc}><path d="M12 3l7 3v5c0 5-3.5 8-7 9-3.5-1-7-4-7-9V6l7-3z" /><path d="M9 12l2 2 4-4" /></svg>
  ),
  // SCADA — monitor jelgörbével
  scada: () => (
    <svg {...svc}><rect x="3" y="4" width="18" height="13" rx="2" /><path d="M8 21h8M12 17v4M7 11l3-3 2 2 4-4" /></svg>
  ),
  // KNX — ház csomóponttal
  knx: () => (
    <svg {...svc}><path d="M3 11l9-7 9 7" /><path d="M5 10v10h14V10" /><circle cx="12" cy="14" r="1.6" /><path d="M12 12.4V9M12 15.6V18M10.4 14H8M13.6 14H16" /></svg>
  ),
}
